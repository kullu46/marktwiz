...
export default class Home extends Component {
  ...
  /* componentDidUpdate(){
    if(this.state.jsLoaded === false){
      window.onload = function() {
        setTimeout(function(){
          jQuery('#slides').pagepiling({
    ...
    return (
      <div>
        ...
        <section id="slider-wrapper" className="position-relative">
          ...
          <OwlCarousel ref="car" options={sliderOptions} >
              <div id="slide-1" className="section content d-flex align-items-center justify-content-center flex-column h-100">
                <div className="container-fluid h-100">
                  <div className="row h-100">
                    <div className="align-items-lg-center col-lg-5 d-flex justify-content-lg-center justify-content-start pl-lg-5 pl-md-2 text-center text-lg-left">
                      <h3 className="mb-4 mb-lg-0 mt-lg-0 pt-5 pt-lg-0">Digital Products & Services</h3>
                    </div>
              ...
              <div id="slide-2" className="section content d-flex align-items-center justify-content-center flex-column h-100">
                <div className="container-fluid h-100">
                  <div className="row h-100">
                    <div className="align-items-lg-center col-lg-5 d-flex justify-content-lg-center justify-content-start pl-lg-5 pl-md-2 text-center text-lg-left">
                      <h3 className="mb-4 mb-lg-0 mt-lg-0 pt-5 pt-lg-0">Innovative Approach & Strategy</h3>
                    </div>
              ...
              <div id="slide-3" className="section content d-flex align-items-center justify-content-center flex-column h-100">
                <div className="container-fluid h-100">
                    <div className="row h-100">
                      <div className="align-items-center align-items-lg-start col-lg-5 d-flex flex-column justify-content-lg-center justify-content-start pl-lg-5 pl-md-2 text-center text-lg-left">
                        <h3 className="mb-4 mb-lg-0 mt-lg-0 pt-5 pt-lg-0">Together We Create Magic</h3>
                        <a href="#!" className="btn mt-lg-5">Check Services <img src={imgArrowWhite} alt="arrow" className="img-fluid"/></a>
                      </div>
                      <div className="col-lg-7 d-flex justify-content-end align-items-end">
              ...
              <div id="slide-4" className="section content d-flex align-items-center justify-content-center flex-column h-100">
                <div className="container-fluid h-100">
                  <div className="row h-100">
                    <img src={imgContact} alt="Marktwiz" className="d-none d-lg-block img-fluid movingImg" style={{width: '100%', position: 'absolute', maxWidth: '70%', top: '-30px'}}/>
                    <div className="align-items-center align-items-lg-start col-lg-8 col-xl-6 d-flex flex-column justify-content-lg-center pl-lg-5 pl-md-2 text-center text-lg-left">
                      <h3 className="mb-4 mb-lg-0 mt-lg-0 pt-5 pt-lg-0">Curious enough<br className="d-none d-lg-block"/>to know more?</h3>
                      <form action="" className="align-items-center align-items-lg-start d-flex flex-column pt-2 pt-lg-5 w-100">
